...
import { LocalImage } from '@src/components/Image';
...
export const IndexPage = (): ReactElement => {
	return (
		<PageLayout>
			...
			/>
			<LocalImage
				src="/images/branding/fullLogo.png"
				alt=""
				height={60}
				width={300}
			/>
			...
			<Text>
				...
				<TextStyle gradient>Lorem ipsum</TextStyle> dolor sit amet, consectetur
			...
			<Div flex flexDirection="col" justifyContent="evenly" padding="16px 0px">
